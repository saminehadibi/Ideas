...
{
    public abstract class IdeasPrjWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static IdeasPrjWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(IdeasPrjWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<IdeasPrjDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<IdeasPrjDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<IdeasPrjDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<IdeasPrjDbContext, Task<T>> func)
        {
            T result;
