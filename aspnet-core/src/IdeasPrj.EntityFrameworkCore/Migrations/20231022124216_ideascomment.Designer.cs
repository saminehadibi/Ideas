...
namespace IdeasPrj.Migrations
{
    ...
    [Migration("20231022124216_ideascomment")]
    partial class ideascomment
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("IdeasPrj.Ideas.Idea", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("IdeasPrj.Ideas.IdeasComment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("IdeasPrj.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("IdeasPrj.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("IdeasPrj.Ideas.IdeasComment", b =>
                {
                    b.HasOne("IdeasPrj.Ideas.Idea", "Idea")
                        .WithMany()
